    ...
    <div className="pt-32 pb-20 px-6 md:px-12 lg:px-20 max-w-7xl mx-auto min-h-screen flex flex-col gap-16 md:gap-24">
      ...
      <div className="flex flex-col gap-16 md:gap-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 relative group cursor-pointer" onClick={() => setSelectedImage("/merch1.jpg")}>
            <img 
              src="/merch1.jpg" 
        ...
        {/* Case 2 */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-1 lg:order-1 relative group cursor-pointer" onClick={() => setSelectedImage("/merch2.jpg")}>
            <img 
              src="/merch2.jpg" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 grid grid-cols-2 gap-4">
            <div className="relative group cursor-pointer h-full" onClick={() => setSelectedImage("/merch3.jpg")}>
              <img 
                src="/merch3.jpg" 
                alt="Брелок 1" 
            ...
            <div className="grid grid-rows-2 gap-4">
              <div className="relative group cursor-pointer h-full" onClick={() => setSelectedImage("/merch4.jpg")}>
                <img 
                  src="/merch4.jpg" 
                  alt="Брелок 2" 
              ...
              <div className="relative group cursor-pointer h-full" onClick={() => setSelectedImage("/merch5.jpg")}>
                <img 
                  src="/merch5.jpg" 
                  alt="Брелок 3" 
                  className="w-full h-full object-cover rounded-sm border border-bee-border group-hover:opacity-90 transition-opacity"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-1 lg:order-1 flex gap-4 h-full">
            <div className="relative group cursor-pointer w-1/2 h-full" onClick={() => setSelectedImage("/merch6.jpg")}>
              <img 
                src="/merch6.jpg" 
                alt="Брелок Аляска 1" 
                className="w-full h-full object-cover rounded-sm border border-bee-border group-hover:opacity-90 transition-opacity"
            ...
            <div className="relative group cursor-pointer w-1/2 h-full" onClick={() => setSelectedImage("/merch7.jpg")}>
              <img 
                src="/merch7.jpg" 
                alt="Брелок Аляска 2" 
                className="w-full h-full object-cover rounded-sm border border-bee-border group-hover:opacity-90 transition-opacity"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 relative group cursor-pointer" onClick={() => setSelectedImage("/merch8.jpg")}>
            <img 
              src="/merch8.jpg" 
