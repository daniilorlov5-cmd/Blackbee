        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-20 items-center mb-16 md:mb-24">
          <div>
            <div className="flex items-center gap-4 mb-6">
              <div className="w-2 h-2 bg-bee-yellow animate-pulse"></div>
              <span className="font-mono text-[9px] md:text-[10px] uppercase tracking-[0.2em] md:tracking-[0.4em] text-bee-yellow">Пром_Инфраструктура_RU+UAE</span>
            </div>
            <h2 className="text-4xl md:text-6xl lg:text-8xl font-black uppercase tracking-tighter leading-[0.85] italic skew-heading mb-6 md:mb-8">
              Ваш склад —<br /><span className="text-bee-yellow">в облаке</span>
            </h2>
          ...
          <div className="relative group p-6 md:p-10 bg-bee-black border border-bee-border overflow-hidden">
            <div className="absolute top-0 right-0 p-4 font-mono text-[9px] text-bee-white/10 uppercase tracking-widest hidden sm:block">Отчет_эффективности_v1.2</div>
            <h4 className="text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] mb-6 md:mb-8 text-bee-yellow italic pt-2 sm:pt-0">Экономика Black Bee</h4>
            ...
            <div className="space-y-6 md:space-y-8">
                <div className="flex flex-col sm:flex-row sm:items-end justify-between border-b border-bee-border pb-4 gap-1 sm:gap-0">
                    <span className="text-[9px] md:text-[10px] uppercase tracking-widest text-bee-white/40">Оборотный капитал</span>
                    <span className="text-lg md:text-xl font-bold italic text-bee-yellow">-40% затрат</span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-end justify-between border-b border-bee-border pb-4 gap-1 sm:gap-0">
                    <span className="text-[9px] md:text-[10px] uppercase tracking-widest text-bee-white/40">Складские площади</span>
                    <span className="text-lg md:text-xl font-bold italic text-bee-yellow">0 м² [Zero]</span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-end justify-between border-b border-bee-border pb-4 gap-1 sm:gap-0">
                    <span className="text-[9px] md:text-[10px] uppercase tracking-widest text-bee-white/40">Минимальный заказ (MOQ)</span>
