...
export function PhotoToModel() {
 ...
 <div className="font-bold text-bee-white uppercase tracking-widest text-sm mb-1">Простое фото</div>
 ...
 <div className="font-bold text-bee-white uppercase tracking-widest text-sm mb-1">Сложный скан</div>
 ...
 <h3 className="text-2xl font-black uppercase tracking-tight mb-4">Сервис в разработке</h3>
