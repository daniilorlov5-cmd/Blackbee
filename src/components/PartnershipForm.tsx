...
"Деятельность / Аудитория": role
 ...
 <div>
 <span className="text-bee-yellow text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] md:tracking-[0.4em] block mb-2 md:mb-4">Агенты_Влияния</span>
 ...
 <h3 className="text-2xl font-black uppercase tracking-tight mb-4">Заявка принята</h3>
 ...
 className="w-full h-16 md:h-20 flex items-center justify-between px-6 md:px-8 bg-bee-white text-bee-black font-black uppercase tracking-[0.2em] text-[9px] md:text-[10px] hover:bg-bee-yellow transition-all duration-300 disabled:opacity-50 group shadow-lg"
 >
 ...
 >
 <span className="leading-tight">НАПИСАТЬ В<br className="hidden md:block"/> TELEGRAM</span> <Send className="w-3.5 h-3.5 md:w-4 md:h-4 ml-2 flex-shrink-0 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
 </a>
 </div>
