...
export function Gallery() {
 ...
 >
 <video src={selectedVideo} className="w-full h-full object-contain" controls autoPlay />
 ...
 <span className="text-bee-yellow text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] md:tracking-[0.4em] block mb-2 md:mb-4">Архив_Кейсов</span>
 ...
 Мы не просто печатаем детали — мы решаем сложные технологические задачи. От макетов до серийного производства.
 </p>
 </div>
 ...
 {project.video ? (
 <video src={project.video} autoPlay muted loop playsInline className="w-full h-full object-cover grayscale-0 md:grayscale md:group-hover:grayscale-0 transition-all duration-700 scale-100 group-hover:scale-105"
 />
 ) : (
 ...
 <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tight mb-4 md:mb-6 group-hover:text-bee-yellow transition-colors whitespace-pre-line">
 {project.title}
 </h3>
 ...
 <div>
 <h4 className="text-xl md:text-2xl font-bold uppercase tracking-tight mb-2">Не нашли похожий проект?</h4>
