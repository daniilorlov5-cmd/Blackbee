...
export function Partners() {
 ...
 <span className={`font-black uppercase tracking-tight ${partner.size} ${partner.highlight ? 'text-bee-white drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]' : 'text-bee-white/20'}`}>
 {partner.name}
 </span>
 ...
 <div className="text-2xl md:text-3xl font-black text-bee-yellow mb-1">+50</div>
 <div className="text-[10px] text-bee-white/40 uppercase tracking-widest font-mono">Корпоративных клиентов</div>
 </div>
 <div className="py-4 sm:py-0 sm:px-6">
 <div className="text-2xl md:text-3xl font-black text-bee-white mb-1">100%</div>
 <div className="text-[10px] text-bee-white/40 uppercase tracking-widest font-mono">Соблюдение NDA</div>
 </div>
 <div className="py-4 sm:py-0 sm:px-6">
 <div className="text-2xl md:text-3xl font-black text-bee-white mb-1">№1</div>
