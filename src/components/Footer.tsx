...
"Другое"
 ...
 <h3 className="text-3xl md:text-4xl font-black uppercase tracking-tight mb-4">Обсудить проект с ведущим инженером</h3>
 ...
 openModal('order', { phone: isTelegram ? '' : val,
 ...
 Промышленная сеть аддитивного производства. Мы работаем по всей России, собирая заказы на сложные статуи и арт-объекты из любой точки страны.
 </p>
 ...
 <div className="text-[10px] text-bee-text-muted font-mono tracking-tight uppercase hidden sm:block opacity-40">
