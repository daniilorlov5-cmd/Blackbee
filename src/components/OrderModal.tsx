...
export function OrderModal() {
 ...
 setFormData(prev => ({
 ...prev,
 name: predefinedData?.phone || '', material: predefinedData?.material || prev.material,
 ...
 <h3 className="text-3xl font-black uppercase tracking-tight mb-4">Данные отправлены</h3>
